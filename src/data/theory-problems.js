...
export const theoryProblems = [
  ...
  {
    id: 100, title: 'Production Calculation', category: 'quantitative', difficulty: 'medium', type: 'theory', tags: ['Math', 'Work'],
    ...
    question: 'A machine produces x units per hour. Due to a fault, it produces only 5/8 of the normal output. How many units will it produce in one hour?',
    options: ['3x/8', '5x/8', 'x/2', '7x/8'],
    correctAnswer: 'B',
    explanation: 'The machine normally produces x units. With the fault, it produces 5/8 of normal. Production = x × 5/8 = 5x/8 units per hour.',
    examples: [{ input: 'Normal production = x units/hr', output: '5x/8 units' }],
    hints: ['Multiply x by the fault fraction 5/8.'],
    answer: '**Answer: 5x/8 units (Option B)**\n\nThe machine normally produces x units. With the fault, it produces 5/8 of normal.\n\nProduction = x × 5/8 = **5x/8 units per hour**'
  },
  {
    id: 101, title: 'Selling Price Problem', category: 'quantitative', difficulty: 'medium', type: 'theory', tags: ['Math', 'Profit'],
    description: 'A shopkeeper buys an article for $320 and sells it at a profit of 18.75%. What is the selling price?',
    question: 'A shopkeeper buys an article for $320 and sells it at a profit of 18.75%. What is the selling price?',
    options: ['$340', '$360', '$380', '$400'],
    correctAnswer: 'C',
    explanation: 'SP = CP × (1 + Profit%/100) = 320 × (1 + 18.75/100) = 320 × 1.1875 = $380',
    examples: [{ input: 'Cost Price = $320, Profit = 18.75%', output: '$380' }],
    hints: ['SP = CP + (Profit% × CP)', 'SP = CP × (1 + Profit%/100)'],
    answer: '**Answer: C) $380**\n\nSP = CP × (1 + Profit/100)\nSP = 320 × (1 + 18.75/100)\nSP = 320 × 1.1875 = **$380**'
  },
  {
    id: 102, title: 'Cube Side Length', category: 'quantitative', difficulty: 'easy', type: 'theory', tags: ['Math', 'Geometry'],
    description: 'The volume of a cube is 512 cm³. What is the length of each side?',
    question: 'The volume of a cube is 512 cm³. What is the length of each side?',
    options: ['6 cm', '7 cm', '8 cm', '9 cm'],
    correctAnswer: 'C',
    explanation: 'Volume = side³. So side = ∛volume = ∛512 = 8 cm',
    examples: [{ input: 'Volume = 512 cm³', output: 'Side = 8 cm' }],
    hints: ['Volume of cube = side³. So side = ∛volume.'],
    answer: '**Answer: C) 8 cm**\n\nVolume = side³\n512 = side³\nside = ∛512 = **8 cm**'
  },
  {
    id: 103, title: 'Average Speed', category: 'quantitative', difficulty: 'medium', type: 'theory', tags: ['Math', 'Speed'],
  ...
  {
    id: 104, title: 'Profit Percentage', category: 'quantitative', difficulty: 'easy', type: 'theory', tags: ['Math', 'Profit'],
  ...
  // ===== VERBAL ABILITY =====
  {
    id: 105, title: 'Synonym — Ephemeral', category: 'verbal', difficulty: 'easy', type: 'theory', tags: ['Vocabulary', 'Synonym'],
    ...
    correctAnswer: 'B',
    explanation: '"Ephemeral" means lasting for a very short time. The correct synonym is **Fleeting**. Opposite words would be: Permanent, Eternal, Lasting',
  ...
  {
    id: 106, title: 'Correct Spelling', category: 'verbal', difficulty: 'easy', type: 'theory', tags: ['Spelling', 'Grammar'],
  ...
  {
    id: 107, title: 'Correct Sentence', category: 'verbal', difficulty: 'medium', type: 'theory', tags: ['Grammar', 'Sentence'],
  ...
  {
    id: 108, title: 'Fill in the Blank — Too/To/Two', category: 'verbal', difficulty: 'easy', type: 'theory', tags: ['Grammar', 'Vocabulary'],
  ...
  {
    id: 109, title: 'Articles — A/An/The', category: 'verbal', difficulty: 'easy', type: 'theory', tags: ['Grammar', 'Articles'],
  ...
  // ===== NUMERICAL ABILITY =====
  {
    id: 110, title: 'Expression Evaluation', category: 'numerical', difficulty: 'easy', type: 'theory', tags: ['Math', 'BODMAS'],
    description: 'Evaluate: 2 + 3 × 4 = ?\n\nA) 20\nB) 14\nC) 12\nD) 24',
    hints: ['Follow BODMAS: Multiplication before Addition.'],
    answer: '**Answer: B) 14**\n\nUsing BODMAS:\n2 + (3 × 4) = 2 + 12 = **14**\n\nMultiplication is done before addition.'
  },
  {
    id: 111, title: 'Solve for x', category: 'numerical', difficulty: 'easy', type: 'theory', tags: ['Algebra', 'Equation'],
    description: 'Solve: 3x + 7 = 28. Find x.\n\nA) 5\nB) 6\nC) 7\nD) 8',
    hints: ['Isolate x: subtract 7, then divide by 3.'],
    answer: '**Answer: C) 7**\n\n3x + 7 = 28\n3x = 28 - 7 = 21\nx = 21/3 = **7**'
  },
  {
    id: 112, title: 'Discount Calculation', category: 'numerical', difficulty: 'easy', type: 'theory', tags: ['Math', 'Percentage'],
    description: 'A shirt costs $40. It is on sale at 15% off. What is the discount?\n\nA) $4\nB) $6\nC) $34\nD) $5',
    answer: '**Answer: B) $6**\n\nDiscount = 15% of $40\n= 0.15 × 40 = **$6**\n\nSale price = $40 - $6 = $34'
  },
  {
    id: 113, title: 'Find Odd Numbers', category: 'numerical', difficulty: 'easy', type: 'theory', tags: ['Number', 'Odd/Even'],
    description: 'Which of these are odd numbers: 28, 31, 33, 44, 56?\n\nA) 28, 44\nB) 31, 33\nC) 56, 44\nD) 31, 56',
    answer: '**Answer: B) 31, 33**\n\nOdd numbers are not divisible by 2.\n- 28 ÷ 2 = 14 (even)\n- **31** (odd)\n- **33** (odd)\n- 44 ÷ 2 = 22 (even)\n- 56 ÷ 2 = 28 (even)'
  },
  {
    id: 114, title: 'Time & Work', category: 'numerical', difficulty: 'medium', type: 'theory', tags: ['Math', 'Time'],
  ...
  // ===== REASONING =====
  {
    id: 115, title: 'Number Series — Find Next', category: 'reasoning', difficulty: 'medium', type: 'theory', tags: ['Series', 'Pattern'],
  ...
  {
    id: 116, title: 'Letter Coding — ORANGE', category: 'reasoning', difficulty: 'medium', type: 'theory', tags: ['Coding', 'Pattern'],
  ...
  {
    id: 117, title: 'Odd One Out', category: 'reasoning', difficulty: 'easy', type: 'theory', tags: ['Pattern', 'Classification'],
  ...
  {
    id: 118, title: 'Letter Coding — FISH', category: 'reasoning', difficulty: 'easy', type: 'theory', tags: ['Coding', 'Alphabet'],
    // FIX: All four options and the stated answer were wrong.
  ...
  {
    id: 119, title: 'Alphabetical Order', category: 'reasoning', difficulty: 'easy', type: 'theory', tags: ['Ordering', 'Pattern'],
